...
export function OpenArrow({
  ...
  className = twMerge(
    `ml-auto hidden origin-center items-center justify-center font-bold transition-transform duration-300 sm:flex ${isOpen ? "rotate-[270deg]" : "rotate-90"}`,
    className,
  );
  return (
...
export default function Footer() {
  return (
    <div className="border-t border-gray-200 p-4 py-8">
      <div className="mx-auto mb-6 flex max-w-[1450px] flex-wrap gap-4 border-b border-gray-300 pb-8 text-gray-900 sm:justify-center">
